...
public class EmployeeController {
	...
	public List<Managers> getManagersDetails() {
		...
		Managers M1 = new Managers("1", "Naresh Manager", 0, 2000.89);
		M1.Work(100);
		M1.TakeVacation(4.6);
		m.add(M1);
		...
		Managers M10 = new Managers("10", "satya Manager", 0, 2030.89);
		M10.Work(200);
		M10.TakeVacation(1.5);
		m.add(M10);
